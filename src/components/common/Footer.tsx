          ...
          <div className="col-span-2 md:col-span-4 space-y-8">
            ...
            <Link to="/" className="inline-flex items-center gap-3 group">
              ...
              <span className="font-sans font-semibold text-xl tracking-tight text-white flex items-center gap-2">
                Budget Ndio Story
                <span className="inline-flex items-center justify-center w-4 h-4 bg-white/10 rounded-none text-white">
                  <svg
            ...
            <div className="flex flex-wrap items-center gap-2.5 text-neutral-400">
              <a
                ...
                rel="noreferrer"
                aria-label="YouTube"
                className="w-8 h-8 rounded-none border border-neutral-800 flex items-center justify-center hover:border-white hover:text-white transition-all duration-200"
              >
                <svg
                  viewBox="0 0 24 24"
                  fill="currentColor"
