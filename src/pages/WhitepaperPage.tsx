    ...
    <main className="w-full bg-white text-[#101010] pt-28 md:pt-36 pb-24">
      <article className="max-w-[740px] mx-auto px-6 md:px-10">
        ...
        <p className="mt-8 font-sans text-base sm:text-[17px] leading-[1.75]">
          A platform for budget literacy, civic accountability, and impact storytelling. This note describes the problem, the two-entity model, and the terms on which a partner may join the work.
        </p>
        ...
        {SECTIONS.map((section) => (
          <section key={section.n} id={section.id} className="mt-14 scroll-mt-24">
            <h2 className="font-display text-2xl tracking-[-0.03em]">
              {section.n}. {section.title}
            </h2>
            {section.body.map((paragraph) => (
              <p key={paragraph.slice(0, 24)} className="mt-4 font-sans text-base leading-[1.75] text-[#101010]/90">
                {paragraph}
              </p>
            ))}
          </section>
        ...
        <p className="mt-16 pt-8 border-t border-[#101010]/12 font-sans text-sm text-[#757575] leading-relaxed">
          ...
          {' · '}
          <Link to="/cookies" className="underline underline-offset-4 hover:text-[#101010]">Cookies</Link>
          {' · '}
          <Link to="/privacy" className="underline underline-offset-4 hover:text-[#101010]">Privacy</Link>
          {' · '}
          <Link to="/contact" className="underline underline-offset-4 hover:text-[#101010]">Contact</Link>
        </p>
      </article>
    </main>
  );
